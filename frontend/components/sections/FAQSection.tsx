        ...
        if (faqList.length === 0) {
          setFaqs([
            ...
            },
            {
              ...
              answer: 'Start by installing our SDK (arkiv-sdk-js for TypeScript or arkiv-sdk-python for Python), then follow our Getting Started guide to connect to Arkiv testnet and create your first database.',
              sortOrder: 5
            }
          ])
        } else {
