            ...
            <div className="w-full lg:w-[392px] h-auto lg:h-[442px] p-4 md:p-6 bg-white rounded-2xl shadow-figma-card flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-row gap-3">
                  ...
                  <a href="/litepaper" className="px-5 py-2 border border-black text-black font-mono text-sm md:text-base rounded-lg hover:bg-gray-50 transition-colors whitespace-nowrap">
                    Read Litepaper
                  </a>
                </div>
              </div>
            ...
            <div className="w-full lg:w-[320px] flex flex-col gap-3">
              ...
              <div className="h-auto lg:h-[442px] p-5 bg-white rounded-2xl shadow-figma-card flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {/* Event Card */}
                  <div className="w-[280px] p-5 bg-[#EDEDED] rounded-2xl shadow-figma-card flex flex-col gap-5">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-[984px] h-[400px] lg:h-[624px] relative rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-8 right-8 flex gap-3">
                <button className="px-5 py-2 border border-black text-black font-mono text-base rounded-lg hover:bg-gray-50 transition-colors">
                  Litepaper
                </button>
                <button className="px-5 py-2 bg-stone-900 text-white font-mono text-base rounded-lg shadow-figma-button-primary hover:bg-stone-800 transition-colors">
                  Quickstart
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-[984px] h-[400px] lg:h-[624px] relative rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-8 right-8">
                <a href="https://glm.golem.network/" className="px-5 py-2 bg-stone-900 text-white font-mono text-base rounded-lg shadow-figma-button-primary hover:bg-stone-800 transition-colors">
                  Get GLM
                </a>
              </div>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex gap-4 items-center">
              <a href="https://usecases.golemdb.io/" className="bg-black px-5 py-2.5 rounded-lg">
          ...
          <div className="flex gap-6 overflow-x-auto">
            {/* CopyPal */}
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-2px_2px_0px_rgba(0,0,0,0.15)] rounded-2xl" />

              <h3 className="font-brutal text-xl font-medium uppercase text-black leading-6">CopyPal</h3>

              <div className="flex flex-col gap-6">
                <div className="bg-[#c7c7c7] h-[132px] rounded-2xl overflow-hidden">
                ...
                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Temporary, cross-device clipboard with file sharing powered by blockchain storage.</p>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <a href="https://copypal.online/" target="_blank" rel="noopener noreferrer" className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View CopyPal" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-[#c7c7c7] h-[132px] rounded-2xl overflow-hidden">
                  <img src="/images/imagedb/imagedb-2025-09-22 o 21.23.19.png" alt="ImageDB screenshot" className="w-full h-[132px] object-cover object-center" />
                </div>

                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Image chunking middleware for Arkiv - splits large images into safe-sized chunks.</p>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <a href="https://imagedb.online/" target="_blank" rel="noopener noreferrer" className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View ImageDB" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              ...
              <h3 className="font-brutal text-xl font-medium uppercase text-black leading-6">FilesDB</h3>

              <div className="flex flex-col gap-6">
                <div className="bg-[#c7c7c7] h-[132px] rounded-2xl overflow-hidden">
                  <img src="/images/filedb/filedb-2025-09-22 o 21.21.59.png" alt="FilesDB screenshot" className="w-full h-[132px] object-cover object-center" />
                </div>

                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Universal file storage middleware with chunking for Arkiv integration.</p>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <a href="https://filedb.online/" target="_blank" rel="noopener noreferrer" className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View FilesDB" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              ...
              <h3 className="font-brutal text-xl font-medium uppercase text-black leading-6">DrawIO DB</h3>

              <div className="flex flex-col gap-6">
                <div className="bg-[#c7c7c7] h-[132px] rounded-2xl overflow-hidden">
                  <img src="/images/drawiodb/drawiodb- 2025-09-23 o 09.46.22.png" alt="DrawIO DB screenshot" className="w-full h-[132px] object-cover object-center" />
                </div>

                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Decentralized diagram editor with blockchain storage for permanent diagram preservation.</p>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <a href="https://drawiodb.online/" target="_blank" rel="noopener noreferrer" className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View DrawIO DB" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Immutable static hosting backed by Arkiv.</p>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center">
                      <div className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View WebDB details" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#ededed] w-[312px] h-[400px] px-5 py-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative flex-shrink-0">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <p className="font-mono text-base text-black leading-[22px]">Showcase portfolio of real applications built with Arkiv - featuring smart caching and blockchain storage.</p>

                  <div className="flex justify-between items-end">
                    <div className="flex items-center justify-between w-[60px]">
                      <span className="font-brutal text-[32px] font-black uppercase text-black leading-[38px]">[</span>
                      <span className="font-brutal text-[32px] font-black uppercase text-black leading-[38px]">6</span>
                      <span className="font-brutal text-[32px] font-black uppercase text-black leading-[38px]">]</span>
                    </div>

                    <div className="w-10 h-10 flex items-center justify-center">
                      <a href="http://moon.dev.golem.network:8850" target="_blank" rel="noopener noreferrer" className="transform scale-y-[-100%]">
                        <img src="/images/arrow-top-right.svg" alt="View Arkiv Portfolio" className="w-10 h-10 hover:invert transition-all duration-200" />
                      </a>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-6 w-full">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-6 h-auto md:h-[216px]">
                ...
                <button className="bg-[#ededed] flex-1 p-4 md:p-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1f1f1f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
                  <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-2px_2px_0px_rgba(0,0,0,0.15)] rounded-2xl" />
                  ...
                  <div className="flex flex-col gap-6">
                    <p className="font-mono text-base text-black group-hover:text-white leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">TypeScript Quickstart Guide</p>
                  </div>
                </button>
                ...
                <button className="bg-[#ededed] flex-1 p-4 md:p-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1f1f1f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
                  ...
                  <div className="flex flex-col gap-6">
                    <p className="font-mono text-base text-black group-hover:text-white leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">Python Quickstart Guide</p>
                  </div>
                </button>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                {/* Litepaper Card */}
                <button className="bg-[#ededed] flex-1 h-auto md:h-[160px] p-4 md:p-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1f1f1f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
                  <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-2px_2px_0px_rgba(0,0,0,0.15)] rounded-2xl" />
                  ...
                  <div className="flex flex-col gap-6">
                    <p className="font-mono text-base text-black group-hover:text-white leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">Litepaper</p>
                  </div>
                </button>
                ...
                <button className="bg-[#ededed] flex-1 h-auto md:h-[160px] p-4 md:p-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1f1f1f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
                  ...
                  <div className="flex flex-col gap-6">
                    <p className="font-mono text-base text-black group-hover:text-white leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">Docs</p>
                  </div>
                </button>
                ...
                <button className="bg-[#ededed] flex-1 h-auto md:h-[160px] p-4 md:p-6 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1f1f1f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
                  ...
                  <div className="flex flex-col gap-6">
                    <p className="font-mono text-base text-black group-hover:text-white leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">Github</p>
                  </div>
                </button>
              </div>
            </div>
  ...
  for (const entity of entities) {
    ...
    console.log(\`\${label} EntityKey: \${entity.entityKey}, Data: \${data}\`)
            ...
            <div className="flex items-center justify-between w-full">
              <div className="bg-[#ededed] p-2 rounded-2xl flex gap-3 items-center">
                <a href="/getting-started" className="bg-[#1f1f1f] px-5 py-2.5 rounded-lg shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] relative hover:bg-gray-800 transition-colors">
                  <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-4px_2px_0px_rgba(0,0,0,0.25)]" />
                  <span className="font-mono text-base text-white leading-[22px]">Build now</span>
                </a>
                <a href="/litepaper" className="px-5 py-2.5 rounded-lg hover:bg-gray-300 transition-colors">
      ...
      <section className="relative z-10 px-4 md:px-[60px] py-[64px] bg-white">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full">
            ...
            <div className="bg-[#ededed] p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col gap-6 relative min-h-[160px] flex-1">
              <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-2px_2px_0px_rgba(0,0,0,0.15)] rounded-2xl" />

              {/* Left Side - Content */}
              <div className="flex-1 flex flex-col gap-4">
                <div className="flex gap-2 items-center">
                  <img className="w-6 h-6" src="/images/location-icon.png" alt="Location" />
                  <span className="font-mono text-sm text-[#1f1f1f] leading-5">Singapore</span>
                </div>

                <div className="flex flex-col gap-1">
                  <h3 className="font-mono text-xl text-[#1f1f1f] leading-7">Arkiv @ Real World Adoption Day</h3>
                  <p className="font-mono text-base text-[#1f1f1f] leading-[22px]">Meetup booth + Keynote</p>
                </div>

                <div className="flex gap-3">
                  <div className="bg-[#1f1f1f] px-5 py-2.5 rounded-lg shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] relative">
                    <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-4px_2px_0px_rgba(0,0,0,0.25)]" />
                    <span className="font-mono text-base text-white leading-[22px]">Event Page</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#ededed] p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col gap-6 relative min-h-[160px] flex-1">
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="font-mono text-xl text-[#1f1f1f] leading-7">Arkiv @ Builder Nights</h3>
                  <p className="font-mono text-base text-[#1f1f1f] leading-[22px]">Talks, Networking & Nice Vibes</p>
                </div>
      ...
      <section className="relative z-10 px-4 md:px-[60px] py-[64px] bg-white">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            {/* Golem - Clickable */}
            <a href="https://golem.network/" target="_blank" rel="noopener noreferrer" className="bg-[#fe7446] w-full lg:w-[254px] h-auto lg:h-[213px] p-4 md:p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#e5673f] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.3)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
            ...
            <a href="https://discord.com/invite/golem" target="_blank" rel="noopener noreferrer" className="bg-[#181ea9] w-full lg:w-[254px] h-auto lg:h-[213px] p-4 md:p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1518a0] hover:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.3)] hover:scale-[1.02] transition-all duration-200 cursor-pointer group">
