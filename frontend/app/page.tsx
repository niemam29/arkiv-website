    ...
    <>
      ...
      <div className="min-h-screen bg-transparent overflow-hidden relative">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="w-[62px] h-8 hidden md:block">
                      <img
                        src="/images/arkiv-logo.svg"
                        alt="Arkiv logo - Universal data layer for Ethereum"
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <a
                      ...
                      className="px-5 py-2 bg-[#1F1F1F] text-white font-mono text-sm md:text-base rounded-lg shadow-figma-button-primary hover:bg-stone-800 transition-colors whitespace-nowrap w-full text-center sm:w-auto"
                    >
                      Build now
                    </a>
                    <a
                      ...
                      className="px-5 py-2 border border-black text-black font-mono text-sm md:text-base rounded-lg hover:bg-gray-50 transition-colors whitespace-nowrap w-full text-center sm:w-auto"
                    >
                      Read Litepaper
                    </a>
                  </div>
              ...
              <div className="w-full lg:w-[480px] flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3 lg:gap-5 lg:h-[442px] p-0 lg:p-5 bg-transparent lg:bg-white rounded-2xl lg:shadow-figma-card">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {/* Event Card */}
                    <a
                      href="https://lu.ma/adoptiondaysingapore"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full lg:w-[420px] p-5 bg-[#EDEDED] rounded-2xl shadow-figma-card flex flex-col gap-5 hover:bg-orange-400 transition-colors duration-200 cursor-pointer"
                    >
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-[648px] px-5 pt-5 pb-10 bg-zinc-100 rounded-2xl flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="font-mono text-base text-stone-900">Web2 is convenient—until lock‑in, outages, or policy changes</div>

                    <div className="w-full h-px bg-neutral-400"></div>
                    <div className="font-mono text-base text-stone-900">Web3 is trustworthy—but painful for data (rigid, slow, costly)</div>

                    <div className="w-full h-px bg-neutral-400"></div>
                    <div className="font-mono text-base text-stone-900">Having to choose between “Convenience” or “Control”</div>
                  </div>
                </div>
                ...
                <div className="w-full lg:w-[648px] h-auto lg:h-[478px] px-5 pt-5 pb-6 bg-blue-800 rounded-2xl flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="font-mono text-base text-white">Queryable by design. CRUD + indexes, not ad‑hoc indexers.</div>
                    ...
                    <div className="w-full h-px bg-white/30"></div>
                    <div className="font-mono text-base text-white">Deterministic & verifiable. Same query → same answer.</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="relative z-10 px-4 md:px-[60px] py-[32px] bg-white">
          <div className="max-w-[1280px] mx-auto">
            <div className="flex flex-col gap-8">
              <h2 id="how-it-works" className="font-brutal text-xl font-medium uppercase text-black">
                [ How it Works ]
              </h2>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-[984px] h-[400px] lg:h-[624px] relative rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-8 right-8 left-8 md:left-auto flex flex-col md:flex-row gap-3">
                    <a
                      href="#getting-started"
                      className="px-5 py-2 bg-stone-900 text-white font-mono text-base rounded-lg shadow-figma-button-primary hover:bg-stone-800 transition-colors text-center w-full md:w-auto"
                    >
                      Quickstart
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2 border border-black text-black font-mono text-base rounded-lg hover:bg-gray-50 transition-colors text-center w-full md:w-auto"
                    >
                      Litepaper
                    </a>
                  </div>
                ...
                <div className="w-full lg:w-[312px] flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="font-mono text-base text-[#1F1F1F]">Final security & verifiability for proofs and commitments</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-80 flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="font-mono text-base text-stone-900">GLM ecosystem incentives align actors across the Arkiv Ecosystem.</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 h-auto md:h-[216px]">
                    ...
                    <a
                      ...
                      className="bg-gray-200 flex-1 p-4 md:p-6 rounded-2xl shadow-figma-card flex flex-col justify-between relative hover:bg-orange-400 hover:shadow-figma-button-primary hover:scale-[1.02] transition-all duration-200 cursor-pointer group min-h-[216px]"
                    >
                      ...
                      <div className="flex flex-col gap-6">
                        <p className="font-mono text-base text-black group-hover:text-black leading-[22px] overflow-hidden overflow-ellipsis transition-colors duration-200">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-gray-200 flex-1 h-auto md:h-[160px] p-4 md:p-6 rounded-2xl shadow-figma-card flex flex-col justify-between relative hover:bg-orange-400 hover:shadow-figma-button-primary hover:scale-[1.02] transition-all duration-200 cursor-pointer group"
                    >
                      <div className="absolute inset-0 pointer-events-none shadow-inner rounded-2xl" />
  ...
  for (const entity of entities) {
    ...
    console.log(\`\${label} EntityKey: \${entity.entityKey}, Data: \${data}\`)
                ...
                <div className="bg-[#ededed] box-border flex flex-col sm:flex-row gap-3 items-center p-2 rounded-2xl w-full">
                  <a
                    href="/getting-started"
                    className="bg-[#1f1f1f] px-5 py-2.5 rounded-lg shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] text-center font-mono text-base text-white hover:bg-gray-800 transition-colors w-full sm:flex-1 relative after:absolute after:inset-0 after:pointer-events-none after:shadow-[inset_0px_2px_2px_0px_rgba(255,255,255,0.25),inset_0px_-4px_2px_0px_rgba(0,0,0,0.25)] after:rounded-lg"
                  >
                    Build now
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-5 py-2.5 rounded-lg text-center font-mono text-base text-black hover:bg-gray-200 transition-colors w-full sm:flex-1"
                  >
                    Read Litepaper
                  </a>
                  <a
        ...
        <section className="relative z-10 px-4 md:px-[60px] py-[32px] bg-white">
          <div className="max-w-[1280px] mx-auto">
            <div className="flex flex-col gap-8">
              <h2 id="faq" className="font-brutal text-xl font-medium uppercase text-black">
                [ FAQ ]
              </h2>
                ...
                {[
                  {
                    ...
                    answer:
                      'Arkiv coordinates DB‑chains (L3) on an OP-Stack based L2 and anchors to Ethereum L1. DB-Chains specialized for data and queries, not general smart contracts.'
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer:
                      'You mainly pay size × lifetime, plus small costs for commitments. No paying for redundant replicas—you pay for the data and how long it lives.'
                  },
                  {
          ...
          <div className="max-w-[1280px] mx-auto">
            <div className="flex flex-col gap-[32px]">
              ...
              <div className="flex flex-col md:flex-row gap-6 w-full">
                ...
                <a
                  href="https://luma.com/adoptiondaysingapore"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  <div className="w-[200px] flex-shrink-0 self-stretch relative rounded-2xl overflow-hidden bg-[#d9d9d9]">
                    <img
                      alt="Arkiv Real World Adoption Day event"
                      className="w-full h-full object-cover"
                      src="/images/Real_World_Adoption_Day.png"
                      loading="lazy"
                    />
                    <div className="absolute top-2 left-2 bg-black/70 text-white px-2 py-1 rounded text-xs font-mono">Sep 30th, 2025</div>
                  </div>
                </a>

                {/* Event 2 - Builder Nights */}
                <a
                  href="https://luma.com/bnsingapore"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gray-200 p-5 rounded-2xl shadow-figma-card flex flex-row items-stretch gap-6 relative min-h-[160px] flex-1 hover:bg-[#FE7445] transition-colors cursor-pointer group"
                >
                  ...
                  <div className="w-[200px] flex-shrink-0 self-stretch relative rounded-2xl overflow-hidden bg-[#d9d9d9]">
                    <img
                      alt="Arkiv Builder Nights event"
                      className="w-full h-full object-cover"
                      src="/images/Builder_Nights.png"
                      loading="lazy"
                    />
                    <div className="absolute top-2 left-2 bg-black/70 text-white px-2 py-1 rounded text-xs font-mono">Oct 1st, 2025</div>
                  </div>
                </a>
              </div>
            </div>
        ...
        <section className="relative z-10 px-4 md:px-[60px] py-[32px] bg-white">
          <div className="max-w-[1280px] mx-auto">
            <div className="flex flex-col gap-[32px]">
              <h2 id="about" className="font-brutal text-lg md:text-xl font-medium uppercase text-black leading-6">
                [ built by ]
              </h2>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="bg-[#f1f1f1] w-full lg:w-[764px] h-auto lg:h-[213px] px-6 py-6 pb-5 rounded-2xl flex flex-col justify-between">
                  <div className="w-[155px] h-[73px]">
                    <img
                      src="/images/golem-logo-large.svg"
                      alt="Golem Network logo - creators of Arkiv blockchain database"
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
                  <p className="font-mono text-base text-[#1f1f1f] leading-[22px] w-full max-w-[601px]">
                    Built within the Golem Ecosystem, Arkiv is a data availability & management layer (L2+L3) combining the usability of
                    Web2 with the trustlessness of Web3. Built on Ethereum.
                  </p>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#fe7446] w-full lg:w-[254px] h-[213px] p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#e5673f] transition-colors duration-200 cursor-pointer group"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#181ea9] w-full lg:w-[254px] h-[213px] p-5 rounded-2xl shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] flex flex-col justify-between relative hover:bg-[#1518a0] transition-colors duration-200 cursor-pointer group"
                >
        ...
        <div className="hidden fixed bottom-6 left-1/2 transform -translate-x-1/2 px-3 pt-2 pb-3 bg-orange-400 rounded-2xl shadow-figma-button-secondary flex flex-col items-center gap-3 z-50">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 bg-white text-black font-mono text-xs rounded-lg shadow-figma-card">Build now</button>
            <button className="px-4 py-2 border border-white text-white font-mono text-xs rounded-lg">Read the Docs</button>
            <button className="px-4 py-2 text-white font-mono text-xs rounded-lg">Talk to us</button>
          </div>
        </div>
      </div>
    </>
