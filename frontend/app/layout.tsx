...
const footerSections = [
  {
    ...
    links: [
      ...
      { name: 'Litepaper (Draft)', href: '/pdf/ARKIV_Litepaper_blue.pdf' },
      { name: 'AIPs (soon)', href: '/aips' },
  ...
  },
  {
    title: 'Connect',
    links: [
      { name: 'Discord', href: 'https://discord.gg/arkiv' },
      { name: 'Twitter', href: 'https://twitter.com/arkiv' },
      { name: 'LinkedIn', href: 'https://linkedin.com/company/arkiv' },
      { name: 'Email', href: 'mailto:hello@arkiv.com' },
    ],
  },
]
...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/arkiv',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
