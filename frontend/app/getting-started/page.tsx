          ...
          <section id="btl" className="mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-gray-200 rounded-2xl p-6 border border-stone-300 shadow-figma-card">
                ...
                <p className="text-stone-900 font-mono text-sm mb-4">BTL determines how long data lives on Arkiv. Each block is approximately 2 seconds on Arkiv Holesky testnet.</p>
...
main().catch(console.error)`}
          ...
          {/* Footer */}
          <section className="px-4 md:px-[60px] py-[64px] bg-[#181EA9] -mx-4 md:-mx-[60px] mt-24">
            <div className="max-w-[1280px] mx-auto">
