            ...
            <aside className="w-[280px] flex-shrink-0">
              <div className="bg-[#EDEDED] p-6 rounded-2xl">
                ...
                <nav className="space-y-3">
                  ...
                  <a href="#acceptance" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    II. Acceptance
                  </a>
                  <a href="#services" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    III. Services
                  </a>
                  <a href="#warranties" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    IV. Warranties
                  </a>
                  <a href="#liability" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    V. Liability
                  </a>
                  <a href="#responsibilities" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    VI. User Responsibilities
                  </a>
                  <a href="#compliance" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    VII. Compliance
                  </a>
                  <a href="#jurisdiction" className="block font-mono text-sm text-gray-700 hover:text-black transition-colors">
                    VIII. Jurisdiction
                  </a>
                </nav>
              </div>
            ...
            <article className="flex-1 max-w-[600px]">
              ...
              <div className="prose prose-sm max-w-none">
                <p className="font-mono text-base text-black leading-[22px] mb-6">
                  These terms govern your use of Arkiv, a universal data layer for Ethereum that enables queryable, time-scoped, and
                  verifiable database chains.
                </p>
                ...
                <section id="overview" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    Arkiv is a decentralized data availability and management platform built on Ethereum. The platform enables developers to
                    create and manage database chains (DB-chains) with built-in querying capabilities, time-based data lifecycle management,
                    and cryptographic verification.
                  </p>
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    By accessing or using Arkiv services, you acknowledge that you understand the decentralized nature of blockchain
                ...
                <section id="acceptance" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    By using Arkiv services, you agree to be bound by these Terms of Use and all applicable laws and regulations. If you do
                    not agree with any part of these terms, you may not use our services.
                  </p>
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    These terms may be updated from time to time, and continued use of the service constitutes acceptance of any
                    modifications.
                  </p>
                </section>
                ...
                <section id="services" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">Arkiv provides:</p>
                ...
                <section id="warranties" className="mb-8">
                  ...
                  <div className="bg-[#F8F8F8] p-4 rounded-lg mb-4">
                    <ul className="list-disc list-inside space-y-2 font-mono text-base text-black leading-[22px]">
                      <li>
                        <strong>Network Congestion:</strong> Transaction delays or failures due to blockchain network conditions
                      </li>
                      <li>
                        <strong>Gas Fee Volatility:</strong> Unpredictable transaction costs on Ethereum network
                      </li>
                      <li>
                        <strong>Fork Events:</strong> Blockchain splits or protocol changes affecting service
                      </li>
                      <li>
                        <strong>Smart Contract Bugs:</strong> Potential vulnerabilities in deployed contracts
                      </li>
                      <li>
                        <strong>Key Management:</strong> Loss of private keys or wallet access
                      </li>
                      <li>
                        <strong>Regulatory Changes:</strong> Government actions affecting blockchain operations
                      </li>
                      <li>
                        <strong>Third-Party Integrations:</strong> Wallet providers, node operators, or other services
                      </li>
                    </ul>
                  </div>
                ...
                <section id="compliance" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    Blockchain technology and cryptocurrency regulations are evolving rapidly. We are committed to operating in compliance
                ...
                <section id="force-majeure" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    We shall not be liable for any failure or delay in performance under these Terms due to circumstances beyond our
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    During force majeure events, we will make reasonable efforts to minimize service disruption and communicate updates to
                    users. Our obligations will be suspended until the force majeure event ends.
                  </p>
                </section>
                ...
                <section id="jurisdiction" className="mb-8">
                  ...
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    These Terms of Use shall be governed by and construed in accordance with the laws of Switzerland, without regard to its
                    conflict of law provisions.
                  </p>
                  <p className="font-mono text-base text-black leading-[22px] mb-4">
                    Any disputes arising from these terms or your use of Arkiv services shall be subject to the exclusive jurisdiction of
                    the courts of Zug, Switzerland.
                  </p>

                  <div className="bg-[#E8F5E8] p-4 rounded-lg mb-4">
                    <h4 className="font-mono text-base font-medium text-black mb-2">🤝 Alternative Dispute Resolution</h4>
                    <p className="font-mono text-sm text-black leading-[20px]">
                      Before initiating formal legal proceedings, parties agree to attempt resolution through good faith negotiations for 30
                      days. For blockchain-specific disputes, we recommend consultation with experts familiar with distributed ledger
                      technology.
                    </p>
                  </div>
